...
/**
 * Autarkia's own live configuration — {@code config/autarkia.json}, edited with
 * {@code /autarkia config}.
 *
 * <p>No tunables of its own yet: the file describes a {@link PersonSpecies Person}, generated by
 * Anima from that declaration. A knob about being a Person would be a new enum joined to this set.
 *
 * <p>Read through the store on every use rather than cached. That is what makes
